...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function rs(e,t,n){let r=new Float32Array(Uo),i=new W(0,1,0);return new Ea({name:`SphericalGaussianBlur`,defines:{n:Uo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:os(),fragmentShader:`
	...
	`}var ss=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Pi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};ru.BlurDirectionX=new U(1,0),ru.BlurDirectionY=new U(0,1);var iu=Math.PI/180,au=9.81;function ou(e){let t=e=>e*e*(3-2*e);return e<.25?t(e/.25):e>.75?t((1-e)/.25):1}var su=class{constructor(){this.pts=[],this.rolls=[],this.types=[],this.p=new W(0,9,0),this.yaw=0,this.pitch=0,this.roll=0,this.s=0,this.marks={}}mark(e){return this.marks[e]=this.s,this}seg(e,{yaw:t=0,pitch:n=0,shape:r=!1,designV:i=null,rollTo:a=null,type:o=`normal`}={}){let s=Math.max(1,Math.round(e)),c=e/s,l=this.roll,u=a===null?l:a*iu,d=0,f=new Float64Array(s);if(r){for(let e=0;e<s;e++)f[e]=ou((e+.5)/s),d+=f[e];var p=i?-Math.atan2(i*i*t*iu/(e*.75),au):0}let m=(e,t,n)=>{this.yaw+=e,this.pitch+=t,this.roll=n;let r=Math.cos(this.pitch),i=Math.sin(this.pitch);this.p.x+=Math.sin(this.yaw)*r*c,this.p.y+=i*c,this.p.z+=Math.cos(this.yaw)*r*c,this.s+=c,this.pts.push(this.p.clone()),this.rolls.push(this.roll),this.types.push(o)};for(let e=1;e<=s;e++)if(r)m(t*iu*f[e-1]/d,n*iu*f[e-1]/d,l+p*f[e-1]);else{let r=e/s,i=r*r*(3-2*r);m(t*iu/s,n*iu/s,l+(u-l)*i)}return this.roll=r?l:u,this}};function cu(){let e=new su;e.mark(`start`),e.seg(14),e.mark(`liftStart`),e.seg(12,{pitch:28,shape:!0,type:`lift`}),e.seg(150,{type:`lift`}),e.mark(`liftEnd`),e.seg(13,{pitch:-74,shape:!0}),e.seg(22,{pitch:-24}),e.seg(12),e.seg(36,{pitch:70,shape:!0}),e.mark(`dropEnd`),e.mark(`speedStraight`),e.seg(150),e.mark(`turnL`),e.seg(168,{yaw:-95,designV:32,shape:!0}),e.seg(30),e.mark(`turnR`),e.seg(150,{yaw:84,designV:30.5,shape:!0}),e.mark(`essEnd`),e.seg(50,{pitch:7,shape:!0}),e.mark(`airtime`),e.seg(18,{pitch:20,shape:!0}),e.seg(24,{pitch:-52,shape:!0}),e.seg(26,{pitch:25,shape:!0}),e.mark(`airtimeEnd`),e.mark(`cpA`),e.seg(24),e.mark(`corkscrew`),e.seg(46,{rollTo:360}),e.mark(`corkscrewEnd`),e.seg(16),e.mark(`scurve`),e.seg(88,{yaw:36,designV:26,shape:!0}),e.seg(88,{yaw:-36,designV:26,shape:!0}),e.mark(`scurveEnd`),e.mark(`cpB`),e.seg(22),e.mark(`loop`),e.seg(97,{pitch:360}),e.mark(`loopEnd`),e.seg(90),e.mark(`skyRamp`),e.seg(86,{pitch:13,shape:!0}),e.seg(72,{pitch:-13,shape:!0}),e.mark(`skyTop`),e.mark(`cpC`),e.mark(`tunnel`),e.seg(16,{pitch:-15,shape:!0}),e.seg(80),e.seg(16,{pitch:15,shape:!0}),e.mark(`tunnelEnd`),e.mark(`helix`),e.seg(168,{yaw:-152,designV:30,shape:!0,pitch:-2}),e.seg(22,{pitch:2,shape:!0}),e.mark(`helixEnd`),e.mark(`brake`),e.seg(46,{type:`brake`}),e.mark(`finish`),e.seg(16,{type:`brake`});let t=e.pts.length,n=e.pts,r=Array(t),i=Array(t),a=Array(t),o=new Et;for(let e=0;e<t;e++){let i=n[Math.max(0,e-1)],a=n[Math.min(t-1,e+1)];r[e]=a.clone().sub(i).normalize()}i[0]=new W(0,1,0).addScaledVector(r[0],-r[0].y).normalize();for(let e=1;e<t;e++){let t=i[e-1].clone().addScaledVector(r[e],-i[e-1].dot(r[e]));i[e]=t.lengthSq()>1e-8?t.normalize():i[e-1].clone()}for(let n=0;n<t;n++)o.setFromAxisAngle(r[n],e.rolls[n]),a[n]=i[n].clone().applyQuaternion(o);let s=e.s,c=e.marks,l=[],u=(e,t=0,n=`ring`)=>l.push({s:e,offset:t,kind:n,taken:!1});u(c.speedStraight+18,0),u(c.speedStraight+34,0),u(c.speedStraight+50,1.4),u(c.speedStraight+66,-1.4),u(c.essEnd+6,0),u(c.airtime+8,0),u(c.airtime+30,1.6),u(c.airtime+44,-1.6),u(c.corkscrewEnd+6,0),u(c.scurveEnd+4,0),u(c.skyTop-20,0),u(c.skyTop+10,0),u(c.tunnel+20,1.5),u(c.tunnel+34,-1.5),u(c.tunnel+48,0),u(c.helixEnd+8,0);let d=[{s:c.cpA,name:`检查点 α · 螺旋入口`,vMin:20,offset:0,taken:!1},{s:c.cpB,name:`检查点 β · 回环入口`,vMin:28,offset:0,taken:!1},{s:c.cpC,name:`检查点 γ · 夜降入口`,vMin:16,offset:0,taken:!1}],f=[{s0:c.corkscrew-4,s1:c.corkscrewEnd+4,name:`危险路段 · 螺旋翻滚`,vMin:18,vMax:1/0},{s0:c.scurve,s1:c.scurveEnd,name:`危险路段 · S形急弯`,vMin:0,vMax:37},{s0:c.loop+2,s1:c.loopEnd-2,name:`危险路段 · 垂直回环`,vMin:12,vMax:1/0},{s0:c.helix,s1:c.helixEnd,name:`危险路段 · 终端螺旋`,vMin:0,vMax:40}];return{n:t,positions:n,tangents:r,ups:a,upNoRoll:i,rolls:e.rolls,types:e.types,marks:c,length:s,rings:l,checkpoints:d,zones:f,startS:2,finishS:c.finish}}var lu={i:0};function uu(e,t,n,r=lu){let i=e.n,a=Tt.clamp(t,0,e.length-.001),o=Math.min(i-2,Math.floor(a)),s=a-o;return n.pos.lerpVectors(e.positions[o],e.positions[o+1],s),n.tan.lerpVectors(e.tangents[o],e.tangents[o+1],s).normalize(),n.up.lerpVectors(e.ups[o],e.ups[o+1],s).normalize(),n.upNR.lerpVectors(e.upNoRoll[o],e.upNoRoll[o+1],s).normalize(),n.roll=e.rolls[o]+(e.rolls[o+1]-e.rolls[o])*s,n.type=e.types[o],n.right.crossVectors(n.tan,n.up).normalize().negate(),n.i=o,n}function du(){return{pos:new W,tan:new W,up:new W,upNR:new W,right:new W,roll:0,type:`normal`,i:0}}function fu(e){let t=new Sn,n=new Oa({color:9413560,metalness:.85,roughness:.35}),r=new Oa({color:2898509,metalness:.6,roughness:.6}),i=new Oa({color:4873072,metalness:.7,roughness:.5}),a=du();for(let r of[-1,1]){let i=[];for(let t=0;t<e.n-1;t+=2)uu(e,t,a),i.push(a.pos.clone().addScaledVector(a.right,r*.62).addScaledVector(a.up,.28));let o=new _a(new Xi(i),i.length*2,.09,6,!1);t.add(new qr(o,n))}let o=new ai(new zi(1.7,.09,.34),r,Math.ceil(e.n/3)),s=new ai(new zi(.16,.06,2.2),new Oa({color:664115,emissive:3662079,emissiveIntensity:.9}),Math.ceil(e.n/3)),c=new q,l=new q,u=0;for(let t=0;t<e.n-1;t+=3)uu(e,t,a),l.makeBasis(a.right,a.up,a.tan),c.copy(l).setPosition(a.pos.x,a.pos.y+.22,a.pos.z),o.setMatrixAt(u,c),c.copy(l).setPosition(a.pos.x+a.up.x*.3,a.pos.y+.3+a.up.y*0,a.pos.z+a.up.z*.3),s.setMatrixAt(u,c),u++;o.count=u,s.count=u,t.add(o,s);let d=new Bi(.35,.5,1,8),f=[];for(let t=8;t<e.n-2;t+=26){let n=e.positions[t];n.y>6&&f.push([n,t])}let p=new ai(d,i,f.length);return f.forEach(([e],t)=>{let n=e.y;c.identity(),c.makeScale(1,n,1),c.setPosition(e.x,n/2,e.z),p.setMatrixAt(t,c)}),t.add(p),t.traverse(e=>{e.frustumCulled=!0}),t}function pu(e){let t=new Sn,n=du(),r=new ga(2.1,.14,10,40),i=new ga(3.1,.22,10,48),a=new Oa({color:666163,emissive:3662079,emissiveIntensity:2.2,metalness:.4,roughness:.3}),o=new Oa({color:3351306,emissive:16758085,emissiveIntensity:2.4,metalness:.4,roughness:.3}),s=(t,r,i)=>{uu(e,r,n),t.position.copy(n.pos).addScaledVector(n.right,i).addScaledVector(n.up,1.35);let a=new q().makeBasis(n.right,n.up,n.tan);return t.quaternion.setFromRotationMatrix(a),t},c={rings:[],checkpoints:[]};for(let t of e.rings)c.rings.push({data:t,mesh:s(new qr(r,a.clone()),t.s,t.offset)});for(let t of e.checkpoints)c.checkpoints.push({data:t,mesh:s(new qr(i,o.clone()),t.s,t.offset)});for(let e of[...c.rings,...c.checkpoints])t.add(e.mesh);return{group:t,items:c}}function mu(e,t,n){let r=new Sn,i=du(),a=[16735912,3662079,16758085,10120191].map(e=>new Oa({color:1118498,emissive:e,emissiveIntensity:1.6})),o=new ga(5.2,.22,8,24,Math.PI),s=0;for(let c=t;c<n;c+=9){uu(e,c,i);let t=new qr(o,a[s%a.length]);t.position.copy(i.pos).addScaledVector(i.up,.5);let n=new q().makeBasis(i.right,i.up,i.tan);t.quaternion.setFromRotationMatrix(n),r.add(t),s++}return r}var hu=[{p:0,top:2312847,hor:16752990,fog:15245421,sun:16763279,sunI:2.4,hemi:.7,stars:0,win:.15,elev:13},{p:.3,top:1781611,hor:14248318,fog:11560570,sun:16751216,sunI:1.4,hemi:.55,stars:.15,win:.5,elev:6},{p:.6,top:792384,hor:4864888,fog:3814752,sun:11569919,sunI:.5,hemi:.4,stars:.6,win:.85,elev:0},{p:1,top:132367,hor:1318717,fog:725542,sun:9417983,sunI:.22,hemi:.28,stars:1,win:1.3,elev:-10}],gu=new J,_u=new J;function vu(e){let t=hu[0],n=hu[hu.length-1];for(let r=0;r<hu.length-1;r++)if(e>=hu[r].p&&e<=hu[r+1].p){t=hu[r],n=hu[r+1];break}let r=(e-t.p)/Math.max(1e-6,n.p-t.p),i=(e,t)=>gu.setHex(e).lerp(_u.setHex(t),r).clone(),a=(e,t)=>e+(t-e)*r;return{top:i(t.top,n.top),hor:i(t.hor,n.hor),fog:i(t.fog,n.fog),sun:i(t.sun,n.sun),sunI:a(t.sunI,n.sunI),hemi:a(t.hemi,n.hemi),stars:a(t.stars,n.stars),win:a(t.win,n.win),elev:a(t.elev,n.elev)}}function yu(){let e=document.createElement(`canvas`);e.width=128,e.height=256;let t=e.getContext(`2d`);t.fillStyle=`#141824`,t.fillRect(0,0,128,256);for(let e=0;e<22;e++)for(let n=0;n<8;n++)t.fillStyle=Math.random()<.42?Math.random()<.7?`#ffca7a`:`#9fd8ff`:`rgba(120,150,190,0.16)`,t.fillRect(6+n*15,8+e*11,9,6);let n=new Fi(e);return n.colorSpace=Le,n}function bu(e,t=`medium`){let n=new jn;n.fog=new An(15245421,80,950);let r=new Ea({side:1,depthWrite:!1,fog:!1,uniforms:{topColor:{value:new J(2312847)},horColor:{value:new J(16752990)},sunDir:{value:new W(.5,.2,-.84).normalize()},sunColor:{value:new J(16763279)},sunI:{value:2.4}},vertexShader:`
      varying vec3 vDir;
      void main(){ vDir = normalize(position); gl_Position = projectionMatrix * modelViewMatrix * vec4(position,1.0); }`,fragmentShader:`
      varying vec3 vDir;
      uniform vec3 topColor, horColor, sunDir, sunColor; uniform float sunI;
      void main(){
        vec3 d = normalize(vDir);
        float h = max(d.y, 0.0);
        vec3 col = mix(horColor, topColor, pow(h, 0.55));
        float s = max(dot(d, normalize(sunDir)), 0.0);
        col += sunColor * (pow(s, 240.0) * sunI + pow(s, 8.0) * sunI * 0.12);
        gl_FragColor = vec4(col, 1.0);
      }`}),i=new qr(new ha(3600,24,16),r);n.add(i);let a=new Float32Array(2700);for(let e=0;e<900;e++){let t=new W().randomDirection();t.y=Math.abs(t.y)*.9+.08,t.normalize().multiplyScalar(3300),a.set([t.x,t.y,t.z],e*3)}let o=new wr;o.setAttribute(`position`,new ur(a,3));let s=new Di({color:14674431,size:2.6,sizeAttenuation:!1,transparent:!0,opacity:0,fog:!1}),c=new Mi(o,s);n.add(c);let l=new so(16763279,2.4),u=new Ka(12572927,3813956,.7);n.add(l,l.target,u);let d=new Oa({color:1119519,roughness:.95,metalness:.05}),f=new qr(new ma(5e3,5e3),d);f.rotation.x=-Math.PI/2,f.position.y=0,n.add(f);let p=new Do(3e3,90,1849941,1320508);p.material.transparent=!0,p.material.opacity=.35,p.position.y=.05,n.add(p);let m=yu(),h=new Oa({color:10134712,map:m,roughness:.8,metalness:.2,emissive:16777215,emissiveMap:m,emissiveIntensity:.15}),g=new zi(1,1,1).translate(0,.5,0),_={low:200,medium:380,high:560},v=new ai(g,h,_[t]||_.medium),y=[];for(let t=0;t<e.n;t+=12)y.push(e.positions[t]);let b=new Kn().setFromPoints(y),x=b.getCenter(new W),S=Math.max(b.max.x-b.min.x,b.max.z-b.min.z)+420,C=new q,w=new J,T=0,E=0;for(;T<v.count&&E<v.count*40;){E++;let e=x.x+(Math.random()-.5)*S,t=x.z+(Math.random()-.5)*S,n=!0;for(let r of y){let i=r.x-e,a=r.z-t;if(i*i+a*a<676){n=!1;break}}if(!n)continue;let r=Math.hypot(e-x.x,t-x.z),i=Tt.mapLinear(r,0,S/2,95,25),a=Math.max(12,i*(.5+Math.random())),o=10+Math.random()*14,s=10+Math.random()*14;C.makeScale(o,a,s).setPosition(e,0,t),v.setMatrixAt(T,C),w.setHSL(.6,.08,.32+Math.random()*.3),v.setColorAt(T,w),T++}return v.count=T,n.add(v),{scene:n,sun:l,hemi:u,stars:c,sky:i,city:v,updateEnv(e,t){let i=vu(Tt.clamp(e,0,1));r.uniforms.topColor.value.copy(i.top),r.uniforms.horColor.value.copy(i.hor),r.uniforms.sunColor.value.copy(i.sun),r.uniforms.sunI.value=i.sunI,n.fog.color.copy(i.fog),l.color.copy(i.sun),l.intensity=i.sunI,u.intensity=i.hemi,s.opacity=i.stars,h.emissiveIntensity=i.win;let a=Tt.degToRad(i.elev),o=new W(Math.cos(a)*.55,Math.sin(a),-Math.cos(a)*.83).normalize();r.uniforms.sunDir.value.copy(o),l.position.copy(t).addScaledVector(o,500),l.target.position.copy(t)}}}function xu(e){let t=new Float32Array(780);for(let e=0;e<260;e++)a(t,e,!0);let n=new wr;n.setAttribute(`position`,new ur(t,3));let r=new Di({color:12576511,size:.07,transparent:!0,opacity:0,blending:2,depthWrite:!1}),i=new Mi(n,r);i.frustumCulled=!1,e.add(i);function a(e,t,n=!1){let r=1.2+Math.random()*5,i=Math.random()*Math.PI*2;e[t*3]=Math.cos(i)*r,e[t*3+1]=Math.sin(i)*r*.6,e[t*3+2]=n?-Math.random()*45-4:-45-Math.random()*6}return{mesh:i,update(e,i){if(r.opacity=Tt.clamp(i-.25,0,.75),r.opacity<=.01)return;let o=20+i*55;for(let n=0;n<260;n++)t[n*3+2]+=o*e,t[n*3+2]>-2&&a(t,n);n.attributes.position.needsUpdate=!0}}}function Su(e){let t=[];function n(n,r=3662079){let i=new Float32Array(126),a=[];for(let e=0;e<42;e++)i.set([n.x,n.y,n.z],e*3),a.push(new W().randomDirection().multiplyScalar(3+Math.random()*7));let o=new wr;o.setAttribute(`position`,new ur(i,3));let s=new Di({color:r,size:.28,transparent:!0,opacity:1,blending:2,depthWrite:!1}),c=new Mi(o,s);c.frustumCulled=!1,e.add(c),t.push({pts:c,vel:a,life:0,geo:o,mat:s})}function r(n){for(let r=t.length-1;r>=0;r--){let i=t[r];i.life+=n;let a=i.geo.attributes.position.array;for(let e=0;e<i.vel.length;e++)a[e*3]+=i.vel[e].x*n,a[e*3+1]+=i.vel[e].y*n-2*i.life*n,a[e*3+2]+=i.vel[e].z*n;i.geo.attributes.position.needsUpdate=!0,i.mat.opacity=Math.max(0,1-i.life/.8),i.life>.8&&(e.remove(i.pts),i.geo.dispose(),i.mat.dispose(),t.splice(r,1))}}return{spawn:n,update:r}}var Cu=9.81,wu=5,Tu=5.5,Eu=7.2,Du=13,Ou=72e-5,ku=.13,Au=60,ju=5.5;function Mu(e){return{s:e.startS,v:5.5,riderX:0,stability:100,energy:55,time:0,maxSpeed:0,ringsTaken:0,cpTaken:0,stallT:0,done:!1,failed:!1,failReason:``,airAmt:0,latEff:0,inZone:null,boosting:!1,braking:!1,onLift:!1}}var Nu=du(),Pu=du();function Fu(e,t){uu(e,t,Nu),uu(e,Math.min(t+2,e.length-.01),Pu);let n=Pu.tan.clone().sub(Nu.tan);return{dyaw:n.dot(Nu.right)/2,dpitch:n.dot(Nu.upNR)/2,roll:Nu.roll,type:Nu.type,frame:Nu}}function Iu(e,t){for(let n of e.zones)if(t>=n.s0&&t<=n.s1)return n;return null}function Lu(e,t,n,r,i={}){let a=[];if(t.done||t.failed)return a;let{dyaw:o,dpitch:s,type:c}=Fu(e,t.s),l=Iu(e,t.s),u=!!i.comfort;t.onLift=c===`lift`;let d=c===`brake`,f=t.v,p=0;t.onLift?t.v+=(wu-t.v)*Math.min(1,r*2.5):d?t.v+=(Tu-t.v)*Math.min(1,r*1.8):(uu(e,t.s,Nu),p+=-9.81*Nu.tan.y,p-=ku+Ou*t.v*t.v,t.boosting=!1,t.braking=!1,n.boost&&t.energy>.5&&(p+=Eu,t.boosting=!0,t.energy=Math.max(0,t.energy-26*r)),n.brake&&(p-=Du,t.braking=!0),t.v+=p*r),t.v=Math.min(Au,Math.max(0,t.v)),t.energy=Math.min(100,t.energy+1.1*r),t.time+=r,t.v>t.maxSpeed&&(t.maxSpeed=t.v);let m=u?5.5:4.2;t.riderX+=(Math.max(-1,Math.min(1,n.lean))-t.riderX)*Math.min(1,r*m),uu(e,t.s,Nu);let h=t.v*t.v*o,g=Nu.roll,_=h*Math.cos(g)+Cu*Math.sin(g),v=t.v*t.v*s;t.airAmt=Math.min(1,Math.max(0,(-9.81-v)/7)),t.inZone=l;let y=Math.abs(_)>.01?t.riderX*-Math.sign(_):0,b=Math.abs(_)-y*3.4,x=0;b>ju&&(x+=(b-ju)*.5),x+=t.airAmt*2,l&&(t.v>l.vMax&&(x+=(t.v-l.vMax)*1.1),t.v<l.vMin&&(t.failed=!0,t.failReason=`速度不足，被困在「${l.name}」`,a.push({type:`fail`,reason:t.failReason}))),u&&(x*=.55),x>0?t.stability-=x*r:t.stability=Math.min(100,t.stability+8*r),t.stability<=0&&(t.stability=0,t.failed=!0,t.failReason=`车体剧烈晃动，过山车脱轨了`,a.push({type:`fail`,reason:t.failReason})),!t.onLift&&!d&&t.v<=.8&&t.s<e.finishS-40?(t.stallT+=r,t.stallT>1.5&&(t.failed=!0,t.failReason=`速度耗尽，列车停在了半坡`,a.push({type:`fail`,reason:t.failReason}))):t.stallT=0;let S=(f+t.v)*.5*r;return t.s+=S,t.latEff=_,e.rings.forEach((e,n)=>{e.taken||Math.abs(t.s-e.s)<2.4&&Math.abs(t.riderX*1.6-e.offset)<1.25&&(e.taken=!0,t.ringsTaken++,t.energy=Math.min(100,t.energy+9),a.push({type:`ring`,index:n}))}),e.checkpoints.forEach((e,n)=>{e.taken||e.missed||(t.s>e.s+4?(e.missed=!0,t.failed=!0,t.failReason=`错过了关键检查点「${e.name}」`,a.push({type:`fail`,reason:t.failReason})):Math.abs(t.s-e.s)<2.6&&Math.abs(t.riderX*1.6-e.offset)<3&&(t.v>=e.vMin?(e.taken=!0,t.cpTaken++,a.push({type:`checkpoint`,index:n})):(e.missed=!0,t.failed=!0,t.failReason=`通过「${e.name}」时速度不足(需 ${(e.vMin*3.6).toFixed(0)} km/h)`,a.push({type:`fail`,reason:t.failReason}))))}),t.s>=e.finishS&&!t.failed&&(t.done=!0,a.push({type:`finish`})),a}function Ru(e,t){let n=t.maxSpeed*3.6,r=Math.max(0,Math.round((165-t.time)*15)),i=t.ringsTaken*120+t.cpTaken*300+Math.round(n*4)+Math.round(t.stability*2)+r,a=`C`;return i>=4300?a=`S`:i>=3400?a=`A`:i>=2500&&(a=`B`),{score:i,grade:a,time:t.time,kmhMax:n,rings:t.ringsTaken,ringsTotal:e.rings.length,cp:t.cpTaken,cpTotal:e.checkpoints.length,stability:Math.round(t.stability),timeBonus:r}}var zu=class{constructor(){this.ctx=null,this.enabled=!0,this._liftAcc=0}ensure(){if(this.ctx)return;let e=window.AudioContext||window.webkitAudioContext;this.ctx=new e;let t=this.ctx;this.master=t.createGain(),this.master.gain.value=.85,this.master.connect(t.destination);let n=t.sampleRate*2;this.noiseBuf=t.createBuffer(1,n,t.sampleRate);let r=this.noiseBuf.getChannelData(0);for(let e=0;e<n;e++)r[e]=Math.random()*2-1;this.wind=this._loopNoise(),this.windFilter=t.createBiquadFilter(),this.windFilter.type=`lowpass`,this.windFilter.frequency.value=400,this.windGain=t.createGain(),this.windGain.gain.value=0,this.wind.connect(this.windFilter).connect(this.windGain).connect(this.master),this.rumble=this._loopNoise(),this.rumbleFilter=t.createBiquadFilter(),this.rumbleFilter.type=`bandpass`,this.rumbleFilter.frequency.value=90,this.rumbleFilter.Q.value=1.2,this.rumbleGain=t.createGain(),this.rumbleGain.gain.value=0,this.rumble.connect(this.rumbleFilter).connect(this.rumbleGain).connect(this.master)}_loopNoise(){let e=this.ctx.createBufferSource();return e.buffer=this.noiseBuf,e.loop=!0,e.start(),e}setEnabled(e){this.enabled=e,this.master&&this.master.gain.setTargetAtTime(e?.85:0,this.ctx.currentTime,.05)}resume(){this.ctx&&this.ctx.state===`suspended`&&this.ctx.resume()}setMotion(e,t,n,r){if(!this.ctx||!this.enabled)return;let i=this.ctx.currentTime,a=Math.min(.62,e*.0085+(e>28?(e-28)*.012:0));this.windGain.gain.setTargetAtTime(a,i,.1),this.windFilter.frequency.setTargetAtTime(320+e*34,i,.1),this.rumbleGain.gain.setTargetAtTime(Math.min(.5,e*.009)+t*.35,i,.08),n&&e>.5&&(this._liftAcc+=r*e,this._liftAcc>1.05&&(this._liftAcc=0,this._tick(170,.05,.16,`square`)))}_env(e,t,n,r){let i=this.ctx.createGain();i.gain.setValueAtTime(0,r),i.gain.linearRampToValueAtTime(t,r+.012),i.gain.exponentialRampToValueAtTime(1e-4,r+n),e.connect(i).connect(this.master)}_tone(e,t,n,r=`sine`,i=null,a=0){if(!this.ctx||!this.enabled)return;let o=this.ctx.currentTime+a,s=this.ctx.createOscillator();s.type=r,s.frequency.setValueAtTime(e,o),i&&s.frequency.exponentialRampToValueAtTime(i,o+t),this._env(s,n,t+.05,o),s.start(o),s.stop(o+t+.08)}_tick(e,t,n,r=`square`){if(!this.ctx||!this.enabled)return;let i=this.ctx.currentTime,a=this.ctx.createOscillator();a.type=r,a.frequency.value=e,this._env(a,n,t,i),a.start(i),a.stop(i+t+.03)}_noiseBurst(e,t,n,r,i=`bandpass`){if(!this.ctx||!this.enabled)return;let a=this.ctx.currentTime,o=this.ctx.createBufferSource();o.buffer=this.noiseBuf;let s=this.ctx.createBiquadFilter();s.type=i,s.Q.value=1.1,s.frequency.setValueAtTime(n,a),s.frequency.exponentialRampToValueAtTime(Math.max(40,r),a+e);let c=this.ctx.createGain();c.gain.setValueAtTime(0,a),c.gain.linearRampToValueAtTime(t,a+.02),c.gain.exponentialRampToValueAtTime(1e-4,a+e),o.connect(s).connect(c).connect(this.master),o.start(a),o.stop(a+e+.1)}boost(){this._noiseBurst(.55,.3,300,2400)}brake(){this._noiseBurst(.3,.14,900,300)}ring(){this._tone(880,.12,.22,`sine`),this._tone(1318,.18,.2,`sine`,null,.07)}checkpoint(){this._tone(523,.14,.26,`triangle`),this._tone(659,.14,.26,`triangle`,null,.09),this._tone(880,.3,.3,`triangle`,null,.18)}warn(){this._tone(233,.12,.2,`square`),this._tone(233,.12,.2,`square`,null,.16)}airtime(){this._noiseBurst(.6,.18,500,1800)}fail(){this._tone(320,.8,.3,`sawtooth`,80),this._tone(208,1,.26,`sawtooth`,60,.1)}finish(){[523,659,784,1046,1318].forEach((e,t)=>this._tone(e,.32,.24,`triangle`,null,t*.11))}click(){this._tick(660,.05,.15,`triangle`)}};function Bu({onPause:e}={}){let t={lean:0,boost:!1,brake:!1},n=new Set,r={v:!1},i={v:!1},a={v:!1},o={v:!1},s=()=>{let e=n.has(`ArrowLeft`)||n.has(`KeyA`)||r.v,s=n.has(`ArrowRight`)||n.has(`KeyD`)||i.v;t.lean=!!s-+!!e,t.boost=n.has(`ArrowUp`)||n.has(`KeyW`)||n.has(`ShiftLeft`)||n.has(`ShiftRight`)||a.v,t.brake=n.has(`ArrowDown`)||n.has(`KeyS`)||n.has(`Space`)||o.v};window.addEventListener(`keydown`,t=>{if([`ArrowLeft`,`ArrowRight`,`ArrowUp`,`ArrowDown`,`Space`].includes(t.code)&&t.preventDefault(),(t.code===`KeyP`||t.code===`Escape`)&&e){e();return}n.add(t.code),s()}),window.addEventListener(`keyup`,e=>{n.delete(e.code),s()}),window.addEventListener(`blur`,()=>{n.clear(),s()});let c=(e,t)=>{let n=e=>{e.preventDefault(),t.v=!0,s()},r=e=>{e.preventDefault(),t.v=!1,s()};e.addEventListener(`pointerdown`,n),e.addEventListener(`pointerup`,r),e.addEventListener(`pointerleave`,r),e.addEventListener(`pointercancel`,r)};return c(document.getElementById(`btn-lean-l`),r),c(document.getElementById(`btn-lean-r`),i),c(document.getElementById(`btn-boost`),a),c(document.getElementById(`btn-brake`),o),t}var Q=e=>document.getElementById(e),Vu=`skylineRush.settings`,Hu=`skylineRush.best`,Uu=class{constructor(){this.el={hud:Q(`hud`),menu:Q(`menu`),pause:Q(`pause`),fail:Q(`fail`),result:Q(`result`),loading:Q(`loading`),touch:Q(`touch`),speed:Q(`speed-num`),alt:Q(`alt-num`),gs:Q(`gs-num`),score:Q(`score-num`),time:Q(`time-num`),rings:Q(`ring-num`),energyFill:Q(`energy-fill`),energyNum:Q(`energy-num`),stabFill:Q(`stab-fill`),stabNum:Q(`stab-num`),stabWrap:Q(`hud-stab`),progressFill:Q(`progress-fill`),progressBar:Q(`progress-bar`),toast:Q(`toast`),failReason:Q(`fail-reason`),grade:Q(`grade`),resultStats:Q(`result-stats`),bestLine:Q(`best-line`),bestLineR:Q(`best-line-r`)},this.settings=this._loadSettings(),this._toastTimer=0,(`ontouchstart`in window||navigator.maxTouchPoints>0)&&this.el.touch.classList.add(`on`),this._syncSettingsInputs(),this.renderBest()}_loadSettings(){try{return{sound:!0,quality:`medium`,comfort:!1,...JSON.parse(localStorage.getItem(Vu)||`{}`)}}catch{return{sound:!0,quality:`medium`,comfort:!1}}}saveSettings(){localStorage.setItem(Vu,JSON.stringify(this.settings))}_syncSettingsInputs(){for(let e of[``,`-p`])Q(`set-sound`+e).checked=this.settings.sound,Q(`set-quality`+e).value=this.settings.quality,Q(`set-comfort`+e).checked=this.settings.comfort}getBest(){try{return JSON.parse(localStorage.getItem(Hu)||`null`)}catch{return null}}saveBest(e){let t=this.getBest();return!t||e.score>t.score?(localStorage.setItem(Hu,JSON.stringify({score:e.score,grade:e.grade,time:e.time})),!0):!1}renderBest(){let e=this.getBest(),t=e?`本地最高分：${e.score}（${e.grade} 级 · ${Wu(e.time)}）`:`暂无记录，来跑第一局吧`;this.el.bestLine.textContent=t,this.el.bestLineR.textContent=t}show(e){for(let t of[`menu`,`pause`,`fail`,`result`])this.el[t].classList.toggle(`hidden`,t!==e);this.el.hud.classList.toggle(`on`,e===null||e===`pause`)}hideLoading(){this.el.loading.style.display=`none`}buildProgress(e){for(let t of e.checkpoints){let n=document.createElement(`div`);n.className=`tick`,n.style.left=`${t.s/e.finishS*100}%`,this.el.progressBar.appendChild(n)}for(let t of e.zones){let n=document.createElement(`div`);n.className=`zone`,n.style.left=`${t.s0/e.finishS*100}%`,n.style.width=`${(t.s1-t.s0)/e.finishS*100}%`,this.el.progressBar.appendChild(n)}}hud(e){this.el.speed.textContent=Math.round(e.kmh),this.el.alt.textContent=Math.round(e.alt),this.el.gs.textContent=e.gText,this.el.score.textContent=e.score,this.el.time.textContent=Wu(e.time),this.el.rings.textContent=`${e.rings}/${e.ringsTotal}`,this.el.energyFill.style.width=`${e.energy}%`,this.el.energyNum.textContent=Math.round(e.energy),this.el.stabFill.style.width=`${e.stability}%`,this.el.stabNum.textContent=Math.round(e.stability),this.el.stabWrap.classList.toggle(`low`,e.stability<35),this.el.progressFill.style.width=`${Math.min(100,e.progress*100)}%`}toast(e,t=``,n=2.2){let r=this.el.toast;r.textContent=e,r.className=t,r.style.opacity=1,clearTimeout(this._toastTimer),this._toastTimer=setTimeout(()=>{r.style.opacity=0},n*1e3)}fillFail(e){this.el.failReason.textContent=e}fillResults(e,t){this.el.grade.textContent=e.grade,this.el.resultStats.innerHTML=[[`总分`,`${e.score}${t?` 🏆 新纪录！`:``}`],[`通关时间`,Wu(e.time)],[`收集能量环`,`${e.rings}/${e.ringsTotal}（+${e.rings*120}）`],[`通过检查点`,`${e.cp}/${e.cpTotal}（+${e.cp*300}）`],[`最高速度`,`${e.kmhMax.toFixed(0)} km/h（+${Math.round(e.kmhMax*4)}）`],[`稳定剩余`,`${e.stability}%（+${e.stability*2}）`],[`时间加成`,`+${e.timeBonus}`]].map(([e,t])=>`<div class="row"><span>${e}</span><span>${t}</span></div>`).join(``)}bind(e){Q(`btn-start`).onclick=e.onStart,Q(`btn-resume`).onclick=e.onResume,Q(`btn-restart-p`).onclick=e.onRestart,Q(`btn-quit-p`).onclick=e.onQuit,Q(`btn-retry-f`).onclick=e.onRestart,Q(`btn-quit-f`).onclick=e.onQuit,Q(`btn-retry-r`).onclick=e.onRestart,Q(`btn-quit-r`).onclick=e.onQuit,Q(`btn-pause-t`).onclick=e.onPause;let t=()=>{for(let e of[``,`-p`])this.settings.sound=Q(`set-sound`+e).checked,this.settings.quality=Q(`set-quality`+e).value,this.settings.comfort=Q(`set-comfort`+e).checked;this.saveSettings(),this._syncSettingsInputs(),e.onSettings(this.settings)};for(let e of[``,`-p`])Q(`set-sound`+e).onchange=t,Q(`set-quality`+e).onchange=t,Q(`set-comfort`+e).onchange=t}};function Wu(e){let t=Math.floor(e/60),n=Math.floor(e%60);return`${t}:${String(n).padStart(2,`0`)}`}var Gu=document.getElementById(`app`),Ku=new Gl({antialias:!0,powerPreference:`high-performance`});Ku.setSize(innerWidth,innerHeight),Gu.appendChild(Ku.domElement);var qu=new io(64,innerWidth/innerHeight,.1,7e3);qu.position.set(0,10,-8);var Ju=new Uu,Yu=new zu,Xu=Ju.settings.quality,Zu=cu(),Qu=fu(Zu),$u=null,ed=null,td=bu(Zu,Xu);td.scene.add(Qu),td.scene.add(qu),td.scene.add(mu(Zu,Zu.marks.tunnel,Zu.marks.tunnelEnd));var nd=xu(qu),rd=Su(td.scene);{let e=new Sn,t=new Oa({color:1318958,metalness:.7,roughness:.35}),n=new qr(new zi(1.9,.42,1.7),t),r=new qr(new zi(1.94,.07,1.74),new Oa({color:397336,emissive:3662079,emissiveIntensity:1.5}));r.position.y=-.18,n.add(r),n.position.set(0,-1.32,-1.9),n.rotation.x=.06,e.add(n),qu.add(e)}var id=new eu(Ku);id.addPass(new tu(td.scene,qu));var ad=new ru(new U(innerWidth,innerHeight),.55,.6,.82);id.addPass(ad);function od(){let e=Ju.settings.quality,t=window.devicePixelRatio||1;Ku.setPixelRatio(e===`low`?Math.min(1,t):e===`medium`?Math.min(1.5,t):t),id.setPixelRatio?.(Ku.getPixelRatio()),id.setSize(innerWidth,innerHeight),ad.enabled=e===`high`}var sd=`menu`,$=null,cd=new Set,ld=0,ud=``,dd=0,fd=0,pd=.12,md=!1,hd=!1,gd=!1,_d=0;function vd(){$u&&td.scene.remove($u),Zu.rings=Zu.rings.map(e=>({...e,taken:!1})),Zu.checkpoints=Zu.checkpoints.map(e=>({...e,taken:!1,missed:!1}));let e=pu(Zu);$u=e.group,ed=e.items,td.scene.add($u)}vd(),Ju.buildProgress(Zu);function yd(){vd(),$=Mu(Zu),fd=0,cd=new Set,ld=0,md=hd=gd=!1,sd=`run`,Ju.show(null),Yu.ensure(),Yu.resume(),Yu.click(),od(),Ju.toast(`坐稳扶好 — 黄昏出发！`)}function bd(){sd===`run`?(sd=`pause`,Ju.show(`pause`),Yu.setEnabled(Ju.settings.sound)):sd===`pause`&&xd()}function xd(){sd=`run`,Ju.show(null),Yu.resume()}function Sd(){sd=`menu`,Ju.show(`menu`),Ju.renderBest()}var Cd=Bu({onPause:()=>{(sd===`run`||sd===`pause`)&&bd()}});Ju.bind({onStart:yd,onResume:xd,onRestart:yd,onQuit:Sd,onPause:()=>{(sd===`run`||sd===`pause`)&&bd()},onSettings:e=>{Yu.setEnabled(e.sound),e.quality!==Xu&&(Xu=e.quality,od())}}),document.addEventListener(`visibilitychange`,()=>{document.hidden&&sd===`run`&&bd()});var wd=du(),Td=du(),Ed=new W,Dd=new W,Od=new W;function kd(e){return Math.sin(e*31.7)*.45+Math.sin(e*17.3+1.7)*.35+Math.sin(e*53.1+4.2)*.2}function Ad(e,t,n){let r=Ju.settings.comfort,i=n===`menu`?dd:$.s,a=n===`menu`?9:$.v;uu(Zu,i,wd),uu(Zu,Math.min(i+10+a*.45,Zu.length-1),Td);let o=r?.45:1;Od.lerpVectors(wd.upNR,wd.up,o).normalize(),Ed.copy(wd.pos).addScaledVector(wd.right,n===`menu`?0:$.riderX*.55).addScaledVector(Od,1.35);let s=(n===`menu`?.2:.6+a*.03)*(r?.3:1)*(sd===`crash`?3:1);if(Ed.addScaledVector(Od,kd(t*1.1)*.02*Math.min(1,a/25)),Dd.copy(Td.pos).addScaledVector(Td.up,1.2),qu.position.copy(Ed),qu.up.copy(Od),qu.lookAt(Dd),n!==`menu`){let e=s*.0035;qu.rotateX(kd(t*1.37+9)*e),qu.rotateY(kd(t*1.11+3)*e*.7),qu.rotateZ($.riderX*-.11+kd(t*.9+5)*e*1.6),sd===`crash`&&qu.rotateZ(ld*2.4)}let c=Tt.clamp((a-5)/34,0,1),l=n===`menu`?66:64+c*(r?6:14)+($&&$.boosting?r?2:5:0);qu.fov+=(l-qu.fov)*Math.min(1,e*3.2),qu.updateProjectionMatrix()}function jd(e){for(let t of e)if(t.type===`ring`){let e=ed.rings[t.index];e.mesh.visible=!1,fd+=120,rd.spawn(e.mesh.position,3662079),Yu.ring()}else if(t.type===`checkpoint`){let e=ed.checkpoints[t.index];fd+=300,rd.spawn(e.mesh.position,16758085),Yu.checkpoint(),Ju.toast(`通过 ${e.data.name}  +300`,`good`)}else if(t.type===`fail`)ud=t.reason,sd=`crash`,ld=0,Yu.fail();else if(t.type===`finish`){let e=Ru(Zu,$),t=Ju.saveBest(e);Ju.fillResults(e,t),Ju.renderBest(),Ju.show(`result`),sd=`result`,Yu.finish()}}function Md(){for(let e of Zu.zones){let t=e.s0;if(!cd.has(t)&&e.s0-$.s<110&&e.s0-$.s>2){cd.add(t);let n=e.vMax===1/0?`保持速度 ≥ ${(e.vMin*3.6).toFixed(0)} km/h!`:`限速 ${(e.vMax*3.6).toFixed(0)} km/h, 注意刹车!`;Ju.toast(`⚠ ${e.name} — ${n}`,`warn`,3),Yu.warn()}}for(let e of Zu.checkpoints){let t=`cp-${e.s}`;!cd.has(t)&&!e.taken&&e.s-$.s<100&&e.s-$.s>2&&(cd.add(t),Ju.toast(`◉ 前方 ${e.name} — 需要 ≥ ${(e.vMin*3.6).toFixed(0)} km/h`,`warn`,3),Yu.warn())}let e=$.inZone;e&&e.vMax!==1/0&&$.v>e.vMax&&(_d+=1,_d%30==1&&Yu.warn(),Ju.toast(`超速！立刻刹车！`,`warn`,.4))}var Nd=new po,Pd=0;function Fd(){requestAnimationFrame(Fd),Nd.update();let e=Math.min(.05,Nd.getDelta()),t=Nd.getElapsed();if(sd===`run`){let t=e;for(;t>1e-6;){let e=Math.min(.008333333333333333,t);if(jd(Lu(Zu,$,Cd,e,{comfort:Ju.settings.comfort})),t-=e,sd!==`run`)break}sd===`run`&&($.boosting&&!md&&Yu.boost(),$.braking&&!hd&&Yu.brake(),$.airAmt>.55&&!gd&&(Yu.airtime(),Ju.toast(`失重！`,``,1.1)),md=$.boosting,hd=$.braking,gd=$.airAmt>.55,Md(),pd=Math.min(1,$.time/150),Pd+=e,Pd>.08&&(Pd=0,Ju.hud({kmh:$.v*3.6,alt:Math.max(0,wd.pos.y-9),gText:$.airAmt>.55?`失重!`:`${(Math.abs($.latEff)/9.81).toFixed(1)}G`,score:fd,time:$.time,rings:$.ringsTaken,ringsTotal:Zu.rings.length,energy:$.energy,stability:$.stability,progress:$.s/Zu.finishS})),Yu.setMotion($.v,.4+($.inZone&&$.v>$.inZone.vMax?.6:0),$.onLift,e),nd.update(e,Tt.clamp(($.v-8)/30,0,1)+($.boosting?.35:0)))}else sd===`crash`?(ld+=e,$.v=Math.max(0,$.v-18*e),Yu.setMotion($.v*.5,.8,!1,e),ld>1.4&&(sd=`fail`,Ju.fillFail(ud),Ju.show(`fail`))):sd===`menu`?(dd=(dd+7*e)%(Zu.length-80),pd=.12,Yu.setMotion?.(0,0,!1,e)):Yu.setMotion?.(5,0,!1,e);if(ed){for(let t of ed.rings)t.mesh.visible&&t.mesh.rotateZ(e*.8);ed.checkpoints.forEach((n,r)=>{if(n.data.taken)n.mesh.scale.setScalar(Math.max(.01,n.mesh.scale.x-e*4));else{let e=1+Math.sin(t*4+r)*.06;n.mesh.scale.setScalar(e),n.mesh.material.emissiveIntensity=2.2+Math.sin(t*4+r)*.8}})}(sd===`menu`||sd===`run`||sd===`pause`||sd===`crash`)&&Ad(e,t,sd===`menu`?`menu`:`run`),td.updateEnv(pd,qu.position),rd.update(e),ad.enabled?id.render():Ku.render(td.scene,qu)}addEventListener(`resize`,()=>{qu.aspect=innerWidth/innerHeight,qu.updateProjectionMatrix(),Ku.setSize(innerWidth,innerHeight),id.setSize(innerWidth,innerHeight)}),od(),Ju.show(`menu`),Ju.hideLoading(),Fd();